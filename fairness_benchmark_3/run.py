...
def train(aggregator, seed : int, epochs : int, learning_rate : float, eps : float):
    ...
    return (model, track_loss1, track_loss2, track_loss3, track_d, track_alpha, track_d_MGDA)
...
def run_experiment(aggregators : List, seeds : List[int], lr : float, epochs : int, eps : float):
    ...
    for seed in seeds:
        ...
        for aggregator in aggregators:
            ...
            model, track_loss1, track_loss2, track_loss3, track_norm_d, track_alpha, track_measure_to_PS = train(aggregator, seed, epochs, lr, eps)
